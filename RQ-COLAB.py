...
Original file is located at
    https://colab.research.google.com/drive/1AFslhrATa8usU_XNOU_JXXOCmP53RDub
"""
...
# Calculate energies
pib_energy_total, por_energy_total, ase = calculate_energies(L, R)
print(f"PIB Energy (6 particles): {pib_energy_total:.2e} J")
print(f"POR Energy (6 particles): {por_energy_total:.2e} J")
print(f"Aromatic Stabilization Energy: {ase:.2e} J")